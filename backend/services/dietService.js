...
//  import { PrismaClient } from '@prisma/client'; // FIX: Corrected the package name
// import AppError from '../utils/AppError.js';
...
//   const newLog = await prisma.dietLog.create({
//     data: {
//       userId, // The userId from the controller is saved here
//       ...logData,
//     },
//   });
//   console.log("service received and created a new diet log");
//   return newLog;
// };


// export const createLog = async (userId, logData) => {
//   // Check user exists before creating diet log
