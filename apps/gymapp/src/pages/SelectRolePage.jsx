...
import parseApiError from '../utils/parseApiError'; // Ensure you have this utility
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-2xl w-full bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
        <div className="text-center space-y-6">
          ...
          {/* ✅ UPDATED GRID to accommodate three items cleanly */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            ...
            {/* ✅ NEW BUTTON for the Merchant Role */}
            <button
